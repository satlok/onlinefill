      ...
      <div class="box box-info">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
              <button type="button" class="btn btn-sm btn-success"  data-toggle="modal" data-target="#modal-capture"><i class="fa fa-image"></i>
               Capture Image</button>
              <button type="button" class="btn btn-sm btn-warning"  data-toggle="modal" data-target="#modal-note">
              <i class="fa fa-file-text"></i> Create Note</button>
            ...
            @if(!empty($subDir))
             ...
             <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="col-md-1">
                        <a href="{{route('view-udir',['id'=>base64_encode($dirs->id)])}}">
                 ...
                 <div class="col-md-12">
                     ...
                     <small class="pull-right"></small>
                            <form role="form"  method="post" action="{{route('file-pdf-user')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" value="{{$dir->id}}" name="d_id">
                            <button type="submit" class="btn btn-sm btn-success" >
                              <i class="fa fa-download"></i> Download all file as pdf</button>
                            </form>
                 ...
                 @foreach($dir->material as $mat)
                    ...
                    <div class="col-md-1">
                        @if($mat->img==NULL)
                         <a href="{{route('view-ufile',['id'=>base64_encode($mat->id)])}}">
                        <i class="fa fa-file-text-o" style=" font-size:55pt;"></i>
                        {{$mat->title}}
                        </a>
                         @else
                        <a href="{{route('view-ufile',['id'=>base64_encode($mat->id)])}}"><img src="{{ asset('public/img/dir/'.$mat->img) }}" height="90" ></a>{{$mat->title}}
                        @endif
                        <!-- /.info-box-content -->
                      </div>
                      <!-- /.col -->
    ...
    <!-- /.content -->
     ...
     <div class="modal modal-default fade" id="modal-note">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form role="form"  method="post" action="{{route('create-umatter')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
        ...
        <!-- /.modal -->
            ...
            <div class="modal modal-default fade" id="modal-capture">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               ...
               <input type="hidden" name="directory_id" value="{{$dir->id}}">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <img id="blah" src="#" alt="Capture pic" width='200' style="display: none;" />                     
                      <script>                     
