              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    {{$user->name}} Has been invited you on his/her board </strong></h1>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        "top" width="50" mc:edit="welcomeEdit-03">
                          ...
                          "http://onlinefill.in/public/img/profilePic/{{$user->prpic}}"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr valign="top">
                        <td valign="top" mc:edit="welcomeEditImgFirst" style="width:19%;color:#505050;font-family:Helvetica;font-size:14px;padding-bottom:1.143em;">
                            @if($board->pic)
                          <img class="profile-user-img img-responsive img-circle" src="http://onlinefill.in/public/img/board/{{$board->pic}}" alt="{{$board->title}}" >
                            @else
                            <img class="profile-user-img img-responsive img-circle" src="http://onlinefill.in/public/img/default.png" alt="{{$board->title}}" >
                            @endif
                            <h3 class="profile-username text-center"><a href="{{route('view-uboard',["id"=>$board->id])}}">{{$board->title}}</a></h3>
                            <a href="http://onlinefill.in/join-to-board/{{$board->b_key}}" class="btn btn-primary btn-block"><b>Join</b></a>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              "templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    ...
                    "http://onlinefill.in/public/logo.png"
                    style="margin:0 auto 0 auto;display:inline-block;"></p>

                    <h6 style="text-align:center;margin-top: 9px;">Online Fill</h6>
