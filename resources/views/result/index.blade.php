                ...
                <table class="table table-hover table-responsive">
                    ...
                    <tbody>
                         @foreach ($result as $res)
                           <tr>         
                               <td><b class="blue-text">{{ $res->job_title }}</b></td>
                               <td class="green-text">{{ $res->opening_date }}</td>
                               <td class="purple-text">{{ $res->exam_date }}</td>
                               <td><a class="btn btn-blue btn-sm" href="{{ $res->url }}" target="_blank" role="button">Download Link</a></td>
                            </tr>
                         @endforeach
                    </tbody>
                </table>
