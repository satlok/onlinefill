...
<script src="{{ asset('public/admin/bower_components/jquery/dist/jquery.min.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ asset('public/js/multiple-emails.js')}}"></script>
	<link type="text/css" rel="stylesheet" href="{{ asset('public/css/multiple-emails.css')}}" />
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('u-board')}}"><i class="fa fa-clipboard"></i> <span>Board</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
